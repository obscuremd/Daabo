    ...
    <SafeAreaView style={{flex:1, width:'full', paddingVertical:20}}>
      ...
      <View style={{alignItems:'center', justifyContent:'space-between', flex:0.9}}>
        ...
        <View style={{width:327, height:4, backgroundColor:'#E3E5E5', borderRadius:50}}>
          <View style={{width:'75%', backgroundColor:'#6B4EFF', height:4, borderRadius:50}}/>
        </View>


        <View style={{alignItems:'center'}}>
          <MaterialIcons name="camera-front" size={54} color="black" />
          <Text style={{fontSize:24, fontWeight:'600'}}>Front Camera</Text>
          <Text style={{fontSize:15, fontWeight:'400', width:300, textAlign:'center', color:'#868686'}}>Try taking a selfie</Text>
        </View>
